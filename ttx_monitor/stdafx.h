...
typedef HRESULT (__stdcall *LPDirectDrawCreate)(GUID FAR *lpGUID, LPDIRECTDRAW FAR *lplpDD, IUnknown FAR *pUnkOuter);
HRESULT __stdcall Hook_DirectDrawCreateEx(GUID FAR *lpGUID, LPDIRECTDRAW FAR *lplpDD, REFIID iid, IUnknown FAR *pUnkOuter);
typedef HRESULT (__stdcall *LPDirectDrawCreateEx)(GUID FAR *lpGUID, LPDIRECTDRAW FAR *lplpDD, REFIID iid, IUnknown FAR *pUnkOuter);
extern LPDirectDrawCreate __DirectDrawCreate;
...
typedef HANDLE (__stdcall *LPCreateEventA)(LPSECURITY_ATTRIBUTES lpEventAttributes,
	BOOL bManualReset,
	BOOL bInitialState,
	LPCSTR lpName);

typedef BOOL (__stdcall *LPSetWindowPos)(HWND hWnd,
